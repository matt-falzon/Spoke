...
namespace FacebookLogin.Services
{
    public class FacebookServices
    {
        ...
        {
            var requestUrl =
                "https://graph.facebook.com/v2.7/me/?fields=name,picture,work,location,locale,cover,age_range,birthday,email,first_name,last_name,gender,hometown&access_token="
                + accessToken;
            /*
			var requestUrl =
